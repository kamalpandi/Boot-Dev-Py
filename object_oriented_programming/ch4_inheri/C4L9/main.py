# Let's extend the Hero class by adding a second child class: the Wizard. 
# Wizard heroes are more powerful than archer heroes. 
# They cast spells at other heroes instead of shooting them, and casting does 25 damage instead of 10 but also costs 25 mana.
...
# If there is not enough mana left, raise a not enough mana exception. 
